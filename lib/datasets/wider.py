...
class wider(imdb):
    def __init__(self, image_set):
        ...
        self._data_path = osp.join(cfg.DATA_DIR, 'wider')
    ...
    def _load_image_set_index(self):
        ...
        with open(image_set_file) as f:
            image_index = [x.strip()[0:-len(self._img_ext) for x in f.readlines()]
        return image_index
    ...
    def _load_wider_annotation(self, index):
        ...
        """
        filename = os.path.join(self._data_path, 'annt', index + '.json')
        with open(filename, 'r') as json_file:
            json_data = json.load(json_file)
            
        num_objs = len(json_data['annotation'])
        ...
        for ix, obj in enumerate(json_data['annotation']):
            bbox = obj['bbox']
            x1 = bbox[0]
            y1 = bbox[1]
            x2 = bbox[2]
